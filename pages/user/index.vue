						...
						<view class="user-info">
							...
							<view class="info">
								...
								<view class="num" v-if="userInfo.phone" @click="goEdit()">
									<view class="num-txt">{{ userInfo.account }}</view>
								</view>
								<!-- #ifdef MP -->
								<button class="phone" v-if="!userInfo.account && isLogin" open-type="getPhoneNumber" @getphonenumber="getphonenumber">{{ $t(`绑定手机号`) }}</button>
								<!-- #endif -->
								<!-- #ifndef MP -->
								<view class="phone" v-if="!userInfo.account && isLogin" @tap="bindPhone">
									{{ $t('绑定手机号') }}
								</view>
								<!-- #endif -->
							</view>
