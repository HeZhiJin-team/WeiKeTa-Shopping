		...
		<view class="whiteBg" v-if="formItem === 1">
				...
				<form @submit.prevent="submit">
					<view class="item">
						<view class="acea-row row-middle">
							...
							<input type="text" :placeholder="$t(`输入邮箱`)" v-model="account" required />
						</view>
					</view>
					<view class="item">
						<view class="acea-row row-middle">
			...
			<view class="list" v-if="current !== 0 || appLoginStatus || appleLoginStatus">
				<view class="item">
					<view class="acea-row row-middle">
						<image src="../static/code_2.png" style="width: 28rpx; height: 32rpx"></image>
						<input type="text" :placeholder="$t(`输入邮箱`)" v-model="account" />
					</view>
				</view>
				<view class="item">
					<view class="acea-row row-middle">
...
import attrs, { required, alpha_num, chs_phone, checkEmail } from '@/utils/validate';
